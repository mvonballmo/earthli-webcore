...
-- 
-- Host: localhost
-- Generation Time: Dec 10, 2005 at 09:13 PM
...
-- 
-- Table structure for table `album_history_items`
-- 

CREATE TABLE `album_history_items` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `object_id` int(10) unsigned NOT NULL default '0',
...
INSERT INTO album_history_items (object_id, object_type, publication_state, user_id, time_created, system_description) VALUES(1, 'folder', 'queued', 1, NOW(), 'Created.');
...
INSERT INTO album_history_items (object_id, object_type, publication_state, user_id, time_created, system_description) VALUES(1, 'user', 'queued', 1, NOW(), 'Created.');
INSERT INTO album_history_items (object_id, object_type, publication_state, user_id, time_created, system_description) VALUES(2, 'user', 'queued', 1, NOW(), 'Created.');

INSERT INTO versions (title, version) VALUES ('com.earthli.albums', '2.9.0');
