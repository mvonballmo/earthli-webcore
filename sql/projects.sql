...
-- 
-- Host: localhost
-- Generation Time: Dec 10, 2005 at 09:56 PM
...
CREATE TABLE `project_changes_to_branches` (
  ...
  PRIMARY KEY  (`entry_to_branch_id`),
...
-- 
-- Table structure for table `project_history_items`
-- 

CREATE TABLE `project_history_items` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `object_id` int(10) unsigned NOT NULL default '0',
...
INSERT INTO project_history_items (object_id, object_type, publication_state, user_id, time_created, system_description) VALUES(1, 'branch', 'queued', 1, NOW(), 'Created.');
...
INSERT INTO project_history_items (object_id, object_type, publication_state, user_id, time_created, system_description) VALUES(1, 'folder', 'queued', 1, NOW(), 'Created.');
...
INSERT INTO project_history_items (object_id, object_type, publication_state, user_id, time_created, system_description) VALUES(1, 'user', 'queued', 1, NOW(), 'Created.');
INSERT INTO project_history_items (object_id, object_type, publication_state, user_id, time_created, system_description) VALUES(2, 'user', 'queued', 1, NOW(), 'Created.');

INSERT INTO versions (title, version) VALUES ('com.earthli.projects', '1.9.0');
