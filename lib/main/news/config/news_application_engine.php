...
/**
 * Creates an {@link NEWS_APPLICATION}.
 ...
 * @since 2.8.0
 */
class NEWS_APPLICATION_ENGINE extends APPLICATION_ENGINE
{
  /**
  ...
  protected function _initialize_class_registry ()
  {
    ...
    $this->register_class ('APPLICATION', 'NEWS_APPLICATION', 'news/sys/news_application.php');
  }
  ...
  protected function _init_application ($page, $app)
  {
    ...
    $app->mail_options->send_from_address = 'news@' . $app->env->default_domain ();
    $app->mail_options->send_from_name = $page->title->group . ' News';
    $app->mail_options->log_file_name = '{logs}news_mail.log';
    ...
    $app->storage->prefix = 'webcore_news_';
  }
}
