...
class RELEASE_STATUS extends WEBCORE_OBJECT
{
  ...
  protected function _as_text ($text_only)
  {
    ...
    if (! isset ($Result))
    {
      ...
      {
        $Result = $this->app->get_text_with_icon($stat->icon_url, $Result, Sixteen_px);
      }
    }
...
class RELEASE_DATE_STATUS extends WEBCORE_OBJECT
{
  ...
  public function as_html ()
  {
    ...
    {
      $this->_html_text = $this->_as_text (false);
      $this->_html_text = $this->app->get_text_with_icon($this->icon_url, $this->_html_text, Sixteen_px);
