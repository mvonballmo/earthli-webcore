...
****************************************************************************/
  ...
  if (isset ($folder))
  {
    $class_name = $App->final_class_name ('MULTIPLE_OBJECT_PURGER_FORM', 'webcore/forms/multiple_object_purger_form.php');
  ...
  <div class="box">
    <div class="box-title">
      <?php echo $App->title_bar_icon ('{icons}buttons/purge'); ?> <?php echo $Page->title->subject; ?>
    </div>
    <div class="box-body">
    <?php
      $form->display ();
