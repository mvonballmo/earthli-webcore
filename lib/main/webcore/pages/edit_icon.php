...
****************************************************************************/
  ...
  <div class="box">
    <div class="box-title">
      <?php echo $App->title_bar_icon ('{icons}buttons/edit'); ?> Edit <?php echo $icon->title_as_html (); ?>
    </div>
    <div class="box-body">
    <?php
      $form->display ();
  ...
  {
    $Page->raise_security_violation ('You are not allowed to edit this icon.', $icon);
  }
?>