...
****************************************************************************/
  ...
  if (isset($user) && isset ($perm) && $App->login->is_allowed (Privilege_set_folder, Privilege_secure, $folder))
  {
    $class_name = $App->final_class_name ('FOLDER_USER_PERMISSIONS_FORM', 'webcore/forms/folder_user_permissions_form.php');
    /** @var $form FOLDER_USER_PERMISSIONS_FORM */
    ...
    $Page->title->subject = 'Edit ' . $perm->title_as_plain_text ();
