...
****************************************************************************/
  ...
  if (isset ($folder))
  {
    $class_name = $App->final_class_name ('MULTIPLE_OBJECT_RESTORER_FORM', 'webcore/forms/multiple_object_restorer_form.php');
    /** @var MULTIPLE_OBJECT_RESTORER_FORM $form */
    ...
    (! $form->object_list->has_entries () || $App->login->is_allowed (Privilege_set_entry, Privilege_create, $folder)))
  {
    ...
    $Page->location->append ($Page->title->subject, '', '{icons}buttons/restore');
