...
****************************************************************************/
  ...
  {
    $class_name = $App->final_class_name ('SEND_OBJECT_IN_FOLDER_FORM', 'webcore/forms/send_object_in_folder_form.php');
    ...
    $Page->title->subject = 'Send Comment';
  ...
  <div class="box">
    <div class="box-title">
      <?php echo $App->title_bar_icon ('{icons}buttons/send'); ?> Send Comment
    </div>
    <div class="box-body">
    <?php
      $form->display ();
