...
class HISTORY_ITEM extends RENDERABLE
{
   ...
   * @var integer
   */
  var $publication_state = History_item_needs_send;
  /**
   ...
   * @return string
   */
  function publication_state_as_text ()
  {
   ...
   * @return string
   */
  function publication_state_as_icon ($size = '16px')
  {
    switch ($this->publication_state)
    {
    case History_item_silent:
   ...
   * @return string
   */
  function kind_as_icon ($size = '16px')
  {
   ...
   * @return string
   */
  function system_description_as_html ($munger = null)
  {
   ...
   * @return string
   */
  function system_description_as_plain_text ($munger = null)
  {
    $sys_desc = $this->system_description;
    if (! $this->exists ())
    {
   ...
   * @access private
   */
  function record_differences (&$obj)
  {
   ...
   * @access private
   */
  function _record_string_difference ($name, $orig_text, $new_text)
  {
   ...
   * @access private
   */
  function _record_object_difference ($name, &$orig, &$new, $empty_text = '[not set]', $prefix = '', $suffix = '')
  {
    if (isset ($orig))
    {
   ...
   * @access private
   */
  function _record_time_difference ($name, $orig_date, $new_date, $type = Date_time_format_short_date_and_time)
  {
   ...
   * @access private
   */
  function _record_boolean_difference ($name, $orig_value, $new_value)
  {
