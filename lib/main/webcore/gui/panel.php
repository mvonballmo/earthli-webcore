...
class PANEL_MANAGER extends WEBCORE_OBJECT
{
   ...
   */
  function move_panel_to ($id, $index, $flags)
  {
   ...
   * appear.
   */
  function move_panel_after ($id, $after, $flags)
  {
   ...
   * @param boolean $show_empty Should empty panels be displayed?
   */
  function display ($show_empty = FALSE)
  {
  ?>
...
<?php
   ...
   * @access private
   */
  function _init_selected_panel_from_request ()
  {
   ...
   * @access private
   */
  function _find_default_panel_id ()
  {
    $Result = '';
 ...
 * @abstract
 */
class PANEL extends WEBCORE_OBJECT
{
  /**
   * @var string
   */
...
class WEBCORE_PANEL_MANAGER extends PANEL_MANAGER
{
   ...
   * @access private
   */
  function _add_folder_panels_for ($folders)
  {
   ...
   * @access private
   */
  function _add_entry_panels_for ($query)
  {
  ...
  function _add_draft_panels_for ($query, $type_info, $panel_class_name)
  {
    ...
    $class_name = $this->app->final_class_name ('ENTRY_PANEL');
 ...
 * @abstract
 */
class GRID_PANEL extends PANEL
{
  /**
  ...
  function _make_grid ()
  {
    $this->raise_deferred ('_make_grid', 'PANEL');
  }
}
 ...
 * @abstract
 */
class QUERY_PANEL extends GRID_PANEL
{
  /**
   * @var boolean
   */
...
class FOLDER_PANEL extends GRID_PANEL
{
   ...
   * @access private
   */
  function recursive_num_objects ($folders)
  {
...
class FORM_PANEL extends PANEL
{
   ...
   * Process the form for this panel.
    * @abstract
    */
  function check () { $this->raise_deferred ('check', 'FORM_PANEL'); }
}
