...
//      $this->_run_beta_tests ();
    ...
    {
      echo "<p>" . 
        $this->context->resolve_icon_as_html("{icons}/indicators/error", "info", Twenty_px) .
        " Congratulations! All [$this->_num_tests] tests have completed successfully.</p>";
    }
    elseif ($this->_num_ignored == $this->_num_errors)
    {
      echo "<p>" . 
        $this->context->resolve_icon_as_html("{icons}/indicators/warning", "info", Twenty_px) .
        " Congratulations! You passed [$this->_num_tests] tests; [$this->_num_ignored] errors were ignored.</p>";
    }
    else
    {
      echo "<p class=\"error\">" . 
        $this->context->resolve_icon_as_html("{icons}/indicators/error", "error", Twenty_px) .
