...
class BROWSER_TEST_TASK extends TEST_TASK
{
  ...
  protected function _test_bots ()
  {
    ...
    $browser->load_from_string ('WebSearchBench WebCrawler V1.0 (Beta), Prof. Dr.-Ing. Christoph Lindemann, Universit�t Dortmund, cl@cs.uni-dortmund.de, http://websearchbench.cs.uni-dortmund.de/');

          $this->_check_equal ('WebSearchBench WebCrawler V1.0 (Beta), Prof. Dr.-Ing. Christoph Lindemann, Universit�t Dortmund, cl@cs.uni-dortmund.de, http://websearchbench.cs.uni-dortmund.de/', $browser->user_agent_string);
          $this->_check_equal ('Unknown', $browser->system_id ());
          $this->_check_equal ('Unknown', $browser->calculated_system_name ());
          $this->_check_equal ('Unknown', $browser->system_name ());
          $this->_check_equal ('', $browser->system_version ());
