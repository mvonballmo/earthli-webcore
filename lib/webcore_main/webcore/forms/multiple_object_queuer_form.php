 ...
 * Abandoning marks entries that are ready to publish, but have not been
 * published yet.
 * @package webcore
 * @subpackage forms
 * @version 3.0.0
...
class MULTIPLE_OBJECT_QUEUER_FORM extends MULTIPLE_OBJECT_ACTION_FORM
{
  ...
  {
    $renderer->draw_text_row ('', 'Are you sure you want to queue ' . $this->object_list->description () . '?');
