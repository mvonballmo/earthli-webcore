...
****************************************************************************/
	require_once ('[[_app_folder_]]/start.php');
  $entry_type_info = $App->type_info_for ('RECIPE', 'recipes/obj/recipe.php');
	require_once ($App->page_template_for ('webcore/pages/delete_entry.php'));
?>
